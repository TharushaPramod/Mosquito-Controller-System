...
const AddReportModal = ({ hospital, onClose, onAdded }) => {
    ...
    const handleSubmit = async () => {
        ...
        // Ensure province is populated even if the hospital object is incomplete
        const assignedProvince = hospital.province ||
            (hospital.district ? PROVINCE_MAP[hospital.district] : 'Unknown');
        ...
        try {
            ...
            if (data.success || res.ok) {
                setSuccess(true);
                if (onAdded) onAdded(data.data || payload);
            ...
            <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg flex flex-col max-h-[92vh] overflow-hidden">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 bg-[#F0F7F5] rounded-t-2xl">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-sm font-extrabold text-[#1A3D37] uppercase tracking-wider">Add Case Report</h2>
                ...
                <div className="flex-1 overflow-y-auto px-6 py-5 flex flex-col gap-4">
                    ...
                    {/* Info */}
                    <div className="bg-[#F0F7F5] rounded-lg px-4 py-3 text-[10px] text-[#2F6A5F] leading-relaxed">
                        ℹ️ This report will be saved to <strong>{hospital?.district}</strong> and immediately reflected in the dashboard, heatmap, and alerts.
                    </div>
