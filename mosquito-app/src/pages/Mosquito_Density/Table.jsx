...
export const Table = () => {
  ...
  useEffect(() => {
    const fetchCumulative = async () => {
      try {
        const res = await fetch("http://localhost:5002/api/users/get"); // ← fixed
  ...
  // ================= Fetch Predictions via Flask =================
  useEffect(() => {
    const fetchPrediction = async () => {
      try {
        // First get actual data to build features
        ...
        // Call Flask ML API
        const kelRes = await fetch("http://localhost:5001/predict", {
          method: "POST",
        ...
        const negRes = await fetch("http://localhost:5001/predict", {
          method: "POST",
          headers: { "Content-Type": "application/json" },
  ...
  useEffect(() => {
    const fetchWeather = async () => {
      try {
        const res = await fetch("http://localhost:5002/api/users/getWeather"); // ← fixed
        const data = await res.json();
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="p-4 bg-white rounded-lg shadow">
                  ...
                  <table className={tableClass}>
                    <thead><tr><th className={thClass}>Year</th><th className={thClass}>Month</th><th className={thClass}>Cumulative</th></tr></thead>
                    <tbody>
            ...
            {predLoading ? <div className="p-10 text-center text-gray-600">Loading prediction data...</div> :
              <div className="grid gap-6 md:grid-cols-2">
                <div className="p-4 bg-white rounded-lg shadow">
                  <h2 className="mb-3 text-lg font-semibold text-blue-600">Kelaniya</h2>
                  <table className={tableClass}>
                    <thead><tr><th className={thClass}>Year</th><th className={thClass}>Month</th><th className={thClass}>Prediction</th></tr></thead>
                    <tbody>
            ...
            {weatherLoading ? <div className="p-10 text-center text-gray-600">Loading weather data...</div> :
              <div className="grid gap-6 md:grid-cols-2">
                <div className="p-4 bg-white rounded-lg shadow">
                  <h2 className="mb-3 text-lg font-semibold text-blue-600">Kelaniya</h2>
                  <table className={tableClass}>
                    <thead><tr><th className={thClass}>Year</th><th className={thClass}>Month</th><th className={thClass}>Rainfall</th><th className={thClass}>Humidity</th><th className={thClass}>Temperature</th></tr></thead>
                    <tbody>
