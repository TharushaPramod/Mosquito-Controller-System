        ...
        <div className="flex min-h-screen w-full">
            ...
            <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#2F6A5F] to-[#1a4d44] relative overflow-hidden items-center justify-center">
                ...
                <div className="relative z-10 text-white text-center p-12">
                    ...
                    <p className="text-lg text-white/80">Login to access your dashboard</p>
                </div>
            </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-gray-50">
                <div className="w-full max-w-md bg-white rounded-2xl shadow-lg p-8">
                    <h2 className="text-2xl font-bold text-[#2F6A5F] mb-2 text-center">Login</h2>
                    ...
                    <form className="space-y-6">
                        ...
                        <div>
                            ...
                            <div className="flex justify-end mt-2">
                                <a href="#" className="text-sm text-[#2F6A5F] hover:underline font-medium">
                                    Forgot password?
                                </a>
                            </div>
                        </div>
                    ...
                    <div className="mt-6 text-center">
                        <p className="text-gray-600">
                            ...
                            <Link to="/signup" className="text-[#2F6A5F] font-semibold hover:underline">
                                Sign Up
                            </Link>
                        </p>
                    </div>
